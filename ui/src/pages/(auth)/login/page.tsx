...
const Login = () => {
  ...
  return (
    <div className="bg-blue-900 h-screen overflow-hidden flex items-center justify-center">
      <div className="bg-white shadow-3xl rounded-xl relative">
        <div className="bg-blue-700 shadow-lg absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-full p-4 md:p-8">
        ...
        <form onSubmit={handleSubmit} className="p-12 md:p-24">
          ...
          <div className="flex items-center text-lg mb-6 md:mb-8 relative">
            <svg className="absolute left-3" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
          ...
          <button
            type="submit"
            className="bg-gradient-to-b from-blue-800 to-blue-900 font-medium p-2 md:p-4 text-white uppercase w-full rounded"
          >
            Login
          </button>
        </form>
